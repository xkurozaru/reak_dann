...
def main():
    """Leakなし"""
    set_seed()
    dataset = ImageFolder("/data2/eto/Dataset/eggplant_fewclass/7class_leak/train", ImageTransform())
